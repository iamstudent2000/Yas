(() => {
    ...
    function positionPopup(trigger, popup) {
        ...
        popup.style.position = 'fixed'; popup.style.width = `${width}px`; popup.style.right = 'auto'; popup.style.left = 'auto'; popup.style.top = '0px'; popup.style.visibility = 'hidden';
    ...
    function positionMenu(button, menu) {
        ...
        menu.style.position = 'fixed'; menu.style.width = `${maxWidth}px`; menu.style.right = 'auto'; menu.style.left = 'auto'; menu.style.top = '0px'; menu.style.visibility = 'hidden';
    ...
    window.persianDatePicker = { reposition: repositionAll };
})();
